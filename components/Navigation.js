    ...
    <nav id="nav-center" className="sticky top-0 z-20 py-2 bg-white md:py-6 md:mb-0 dark:bg-black">
      <div className="container px-4 mx-auto lg:max-w-4xl flex items-center justify-between">
        ...
        <div className={`lg:flex items-center ${isOpen ? 'block' : 'hidden'} w-full lg:w-auto`}>
          ...
          <Link href="#skills" className="block lg:inline-block mt-2 lg:mt-0 ml-0 lg:ml-6 font-medium tracking-wider transition-colors text-gray-900 hover:text-sky-500 uppercase dark:text-white">
            Skills
          </Link>
